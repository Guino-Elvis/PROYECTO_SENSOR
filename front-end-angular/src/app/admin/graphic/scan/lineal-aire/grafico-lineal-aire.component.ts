...
@Component({
  selector: 'app-grafico-lineal-aire',
  standalone: true,
  templateUrl: './grafico-lineal-aire.component.html',
  styles: []
})
export class GraficoLinealAireComponent {
  @Input() aire!: Sensor;
  ...
  ngAfterViewInit(): void {
    setTimeout(() => {
      if (this.aire?.lectura?.length) {
        this.crearGrafico(this.aire);
      }
    }, 0);
  }
